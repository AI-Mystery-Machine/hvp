...
export class HomePgComponent implements OnInit {
  ...
  portfolio: any = [
    ...
    { logo: "/assets/icons/ab-testing.png", uCase: 'Data/ML Consulting', tech: "AWS", method: "Statistics", year: '2020-2021', heading: "Experimentation Platform", shortDes: "Creating an Experimentation Platform (ExP) for J.P Morgans Chase mobile app.", details: "Comming Soon! <br/><br/> <b style='color:green !important;'> Company: </b> J.P Morgan <br/> <strong>Role:</strong> Data Science Experimentation Lead <br/> <strong>Year:</strong> 2021 <br/> <strong>Toolset:</strong> AWS; Python; Split.io <br/> <strong>Method:</strong> Experimental Design, Bayesian Statistics."},
